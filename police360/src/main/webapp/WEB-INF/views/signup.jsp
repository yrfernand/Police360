...
<!-- <!-- CSS Style --> 
 <link rel="stylesheet" type="text/css" href="static/assets/css/internal.css"> 
<!-- <link rel="stylesheet" type="text/css" href="static/assets/css/bootstrap.min.css"> -->
<!-- <link rel="stylesheet" type="text/css" href="static/assets/css/font-awesome.css" media="all"> -->
<!-- <link rel="stylesheet" type="text/css" href="static/assets/css/simple-line-icons.css" media="all"> -->
<!-- <link rel="stylesheet" type="text/css" href="static/assets/css/style.css" media="all"> -->
<!-- <link rel="stylesheet" type="text/css" href="static/assets/css/revslider.css" > -->
...
<!-- <link rel="stylesheet" type="text/css" href="static/assets/css/jquery.mobile-menu.css"> -->
...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Join POLICE360</h1>
...
<!-- <!--       </ul> --> 
  ...
  <div class="container__child signup__form">
    <form:form action="signup" modelAttribute="users" method="post">
     <div class="form-group">
        <label for="fname2">First Name</label>
        <form:input path="fname2" class="form-control" placeholder="First Name"/>
        <form:errors path="fname2" class="text-danger text-center"/>
      </div>
     <div class="form-group">
       <label for="lname2">Last Name</label>
        <form:input path="lname2" class="form-control" placeholder="Last Name"/>
        <form:errors path="lname2" class="text-danger text-center"/>
      </div>
     
      <div class="form-group">
       <label for="email2">Email</label>
        <form:input path="email2" class="form-control" placeholder="Email"/>
        <form:errors path="email2" class="text-danger text-center"/>
      </div>
       <div class="form-group">
       <label for="username2">Username</label>
        <form:input path="username2" class="form-control" placeholder="Username"/>
        <form:errors path="username2" class="text-danger text-center"/>
        </div>
      <div class="form-group">
        <label for="password2">Password</label>
        <form:input path="password2" class="form-control" placeholder="Password"/>
        <form:errors path="password2" class="text-danger text-center"/>
      </div>
      <div class="form-group">
        <label for="fname2">Re-Enter Password</label>
        <form:input path="password" class="form-control" placeholder="Re-Enter Password"/>
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          ...
          <li>
            <a class="signup__link" href="http://localhost:2000/capstone/login">I am already a member</a>
          </li>
        </ul>
      </div>
    </form:form>  
...
<!--                   <br> -->
<%--                   <form:input type="text" path="fname2"  class="input-text"  placeholder="First Name"/> --%>
<%-- 		          <form:errors path="fname2" class="required"/> --%>
<!--                 </li> -->
<!--                 <li> -->
<!--                   <label for="password">Last Name <span class="required">*</span></label> -->
<!--                   <br> -->
<%-- 		          <form:input type="text" path="lname2" class="input-text"  placeholder="Last Name"/> --%>
<%-- 		          <form:errors path="lname2" class="required"/> --%>
<!--                 </li> -->
<!--                 <li> -->
<!--                   <label for="password">Email <span class="required">*</span></label> -->
<!--                   <br> -->
<%--                   <form:input type="hidden" path="id"/> --%>
<%-- 		          <form:input type="email" path="email2" class="input-text"  placeholder="E-mail"/> --%>
<%-- 		          <form:errors path="email2" class="required"/> --%>
<!--                 </li> -->
<!--                 <li> -->
<!--                   <label for="password">Password <span class="required">*</span></label> -->
<!--                   <br> -->
<%--                   <form:input type="password" path="password2" class="input-text"  placeholder="Password"/> --%>
