      ...
      <div class="row">
        <section class="col-main col-sm-9">
          ...
          <div class="static-contain">
            <p>Developing and maintaining trusting relationships are the foundation of community policing and are essential to preventing crime, terrorism, and targeted violence. Law enforcement agencies need to identify challenges, issues, and concerns that emerge at the neighborhood level by gathering real-time data.</p> 
            <p>Police 360 is a community policing platform where both officers and members of a community can build and nurture trust between one another.  This shall be done by engaging in projects and events with one another.</p>
